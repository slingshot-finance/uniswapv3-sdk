...
var (
	...
	feeT = uint64(constants.FeeMedium)
...
func TestAddCallParameters(t *testing.T) {
	...
	pos, err := entities.NewPosition(pool01T, big.NewInt(0), -constants.TickSpacings[uint64(constants.FeeMedium)], constants.TickSpacings[uint64(constants.FeeMedium)])
	assert.NoError(t, err)
	...
	pos, err = entities.NewPosition(pool01T, big.NewInt(1), -constants.TickSpacings[uint64(constants.FeeMedium)], constants.TickSpacings[uint64(constants.FeeMedium)])
	assert.NoError(t, err)
	opts = &AddLiquidityOptions{
		MintSpecificOptions: &MintSpecificOptions{
			Recipient: recipientT,
	...
	// useNative
	pos, err = entities.NewPosition(pool1wethT, big.NewInt(1), -constants.TickSpacings[uint64(constants.FeeMedium)], constants.TickSpacings[uint64(constants.FeeMedium)])
	assert.NoError(t, err)
	opts = &AddLiquidityOptions{
		CommonAddLiquidityOptions: &CommonAddLiquidityOptions{
			SlippageTolerance: slippageToleranceT,
...
func TestRemoveCallParameters(t *testing.T) {
	...
	pos, err = entities.NewPosition(pool01T, big.NewInt(50), -constants.TickSpacings[uint64(constants.FeeMedium)], constants.TickSpacings[uint64(constants.FeeMedium)])
	assert.NoError(t, err)
	opts = &RemoveLiquidityOptions{
		TokenID:             tokenIDT,
	...
	// works
	pos, err = entities.NewPosition(pool01T, big.NewInt(100), -constants.TickSpacings[uint64(constants.FeeMedium)], constants.TickSpacings[uint64(constants.FeeMedium)])
	assert.NoError(t, err)
	opts = &RemoveLiquidityOptions{
		TokenID:             tokenIDT,
		LiquidityPercentage: core.NewPercent(big.NewInt(1), big.NewInt(1)),
