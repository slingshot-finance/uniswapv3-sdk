...
var (
	...
	rpool_0_1, _    = NewPool(rtoken0, rtoken1, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(constants.One, constants.One), big.NewInt(0), 0, nil)
	rpool_0_weth, _ = NewPool(rtoken0, rweth, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(constants.One, constants.One), big.NewInt(0), 0, nil)
	rpool_1_weth, _ = NewPool(rtoken1, rweth, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(constants.One, constants.One), big.NewInt(0), 0, nil)
)
...
func TestMidPrice(t *testing.T) {
	...
	pool_0_1, _ := NewPool(rtoken0, rtoken1, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(big.NewInt(1), big.NewInt(5)), big.NewInt(0), r, nil)

	r, _ = utils.GetTickAtSqrtRatio(utils.EncodeSqrtRatioX96(big.NewInt(15), big.NewInt(30)))
	pool_1_2, _ := NewPool(rtoken1, rtoken2, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(big.NewInt(15), big.NewInt(30)), big.NewInt(0), r, nil)

	r, _ = utils.GetTickAtSqrtRatio(utils.EncodeSqrtRatioX96(big.NewInt(3), big.NewInt(1)))
	pool_0_weth, _ := NewPool(rtoken0, rweth, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(big.NewInt(3), big.NewInt(1)), big.NewInt(0), r, nil)

	r, _ = utils.GetTickAtSqrtRatio(utils.EncodeSqrtRatioX96(big.NewInt(1), big.NewInt(7)))
	pool_1_weth, _ := NewPool(rtoken1, rweth, uint64(constants.FeeMedium), utils.EncodeSqrtRatioX96(big.NewInt(1), big.NewInt(7)), big.NewInt(0), r, nil)
